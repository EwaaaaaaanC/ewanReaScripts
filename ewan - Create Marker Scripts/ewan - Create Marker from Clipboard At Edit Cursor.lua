-- @description Create Marker from Clipboard at Edit Cursor
-- @author ewan
-- @version 1.0
-- @about
--   Create Marker from Clipboard at Edit Cursor
...
local markerNAME = clipboard -- use clipboard if you want, or "presetnamehere"
