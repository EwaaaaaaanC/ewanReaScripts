-- @description Create Marker (Magenta) At Edit Cursor (for sequence break)
-- @author ewan
-- @version 1.0
-- @about
--   Create Magenta Marker at Edit Cursor named Sequence Break

-- This Script creates markers with a set color and name.

local HEX_COLOR = "#ff00ff"     -- in HEX format
...
local markerNAME = "sequenceBreak"
