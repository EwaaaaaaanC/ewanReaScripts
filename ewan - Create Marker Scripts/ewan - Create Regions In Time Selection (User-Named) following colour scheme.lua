-- @description Create User-Named Regions In Time Selection, following colour scheme.
-- @author ewan
-- @version 1
-- @about
...
local retval, rgnName =  reaper.GetUserInputs("ewan: Create Region", 1,"Region Name: ","")
