...
--HOW TO:
-- COPY the first three columns in config for the steps you want to paste.
...
conversionTable = {"NPCs","Warrior", "Witch", "Ranger", "Duelist", "Shadow", "Templar", "Warrior", "Sorceress", "Huntress", "Mercenary", "Monk", "Druid",      
...
conversionTableShortToMeta = {"Str4", "Int4", "Dex4", "StrDex4", "DexInt4", "StrInt4", "Str4b", "Int4b", "Dex4b", "StrDex4b", "DexInt4b", "StrInt4b",      
"Metadata/Characters/Str/StrFour", "Metadata/Characters/Int/IntFour", "Metadata/Characters/Dex/DexFour", "Metadata/Characters/StrDex/StrDexFour", "Metadata/Characters/DexInt/DexIntFour", "Metadata/Characters/StrInt/StrIntFour", "Metadata/Characters/Str/StrFourb", "Metadata/Characters/Int/IntFourb", "Metadata/Characters/Dex/DexFourb", "Metadata/Characters/StrDex/StrDexFourb", "Metadata/Characters/DexInt/DexIntFourb", "Metadata/Characters/StrInt/StrIntFourb" }

-- order of the list in the GUI.
checklistOrder = {"Warrior", "Witch", "Sorceress", "Ranger", "Huntress", "Mercenary", "Monk", "Druid", "Mercenary", "Shadow", "Templar", "Marauder"}
...
function convertToMetadata (input)
local result
        for n = 1, 12 do
          if input == conversionTableShortToMeta[n] then
          result = conversionTableShortToMeta[n+12]
          end
        end
        
        if result == nil then
        result = convertNameToShortName(input)
        end
        
        if result == nil then
        result = "NPCs"
        end
        -- this final block allows things to pass on import all if no class tags.
...
reaper.Undo_EndBlock("Paste ALL from Config Editor (CharacterTextAudio)",-1)
end
...
reaper.Undo_EndBlock("Paste from Config Editor, Filtered (CharacterTextAudio)",-1)
end
...
stepCount = (#configTable+1)/4

for i = 1, stepCount do
  assetList = {}
  textList = {}
  id = configTable[i*4-3]
  speakerShort = id:match("([^_]+)")
  speaker = convertToMetadata(speakerShort)
  --speaker = convertNameToShortName(speakerPlainText)
  text = configTable[i*4-1]
  assets = configTable[i*4-2]
