-- @description Do Action For Each Cluster in Selection
-- @author ewan
-- @version 1.0
-- @about
...
reaper.Main_OnCommand(40348, 0) -- Create Regions For Selected Items

--reaper.Main_OnCommand(41173, 0) -- Moved Edit Cursor To Start of Items
--reaper.Main_OnCommand(40157, 0) -- Create Marker For Selected Items. I.e., put marker at each cluster start

-- NOTE: If your action is not 5 numbers, but a string...
-- Use the below line and replace what is between the quote marks with the string
-- reaper.Main_OnCommand(reaper.NamedCommandLookup("_XENAKIOS_NUDGETAKEVOLUP"), 0)
